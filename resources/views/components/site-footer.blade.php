<footer class="mt-auto bg-oassab-blue-dark text-white">
    <div class="container-oassab grid gap-10 py-14 md:grid-cols-3">
        <div class="space-y-4">
            <a href="{{ url('/') }}" class="inline-block">
                <img src="/images/icone.png" alt="OASSAB" class="h-16 w-auto">
            </a>
            <p class="max-w-sm text-sm text-white/70">
                Obras de Assistência e de Serviço Social da Arquidiocese de Brasília — fé que se transforma em ação há mais de 60 anos.
            </p>
        </div>

        <div>
            <h4 class="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-oassab-orange">Navegação</h4>
            <ul class="space-y-2 text-sm">
                <li><a class="text-white/80 hover:text-oassab-orange" href="{{ url('/') }}">Home</a></li>
                <li><a class="text-white/80 hover:text-oassab-orange" href="{{ url('/quem-somos') }}">Quem somos</a></li>
                <li><a class="text-white/80 hover:text-oassab-orange" href="{{ url('/projetos') }}">Projetos</a></li>
                <li><a class="text-white/80 hover:text-oassab-orange" href="{{ url('/transparencia') }}">Portal Transparência</a></li>
                <li><a class="text-white/80 hover:text-oassab-orange" href="{{ url('/noticias') }}">Notícias</a></li>
                <li><a class="text-white/80 hover:text-oassab-orange" href="{{ url('/relatorios-de-atividades') }}">Relatórios de Atividades</a></li>
                <li><a class="text-white/80 hover:text-oassab-orange" href="{{ url('/contato') }}">Contato</a></li>
            </ul>
        </div>

        <div>
            <h4 class="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-oassab-orange">Contato</h4>
            <ul class="space-y-3 text-sm text-white/80">
                <li>SGAS 601 — Asa Sul, Brasília — DF</li>
                <li><a class="hover:text-oassab-orange" href="tel:+556120992218">(61) 2099-2218</a></li>
                <li><a class="hover:text-oassab-orange" href="tel:+556120992219">(61) 2099-2219</a></li>
                <li><a class="hover:text-oassab-orange" href="mailto:contato@oassab.org.br">contato@oassab.org.br</a></li>
            </ul>
            <div class="mt-5 flex gap-3">
                <a href="https://www.instagram.com/oassabdf/" target="_blank" rel="noopener" aria-label="Instagram"
                   class="flex h-9 w-9 items-center justify-center rounded-full border border-white/30 text-white transition hover:border-oassab-orange hover:bg-oassab-orange hover:text-white">
    ...
    <div class="border-t border-white/10">
        <div class="container-oassab flex flex-col items-center justify-between gap-2 py-5 text-xs text-white/60 md:flex-row">
            <p>Obras Sociais da Arquidiocese de Brasília.</p>
            <p>&copy; {{ date('Y') }} OASSAB. Todos os direitos reservados.</p>
        </div>
    </div>
</footer>
